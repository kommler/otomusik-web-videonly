...
const getMusicVideoStatusColors = (status: string) => {
...
// Status options for music videos
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {musicVideoStatusOptions.map((status) => {
              ...
              const colors = getMusicVideoStatusColors(status.value);
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  value={tempFilters.title__ilike || ''}
              ...
              <div>
                ...
                <Input
                  value={tempFilters.channel_name__ilike || ''}
                  onChange={(e) => setTempFilters({
                    ...tempFilters,
              ...
              <div>
                ...
                <Input
                  value={tempFilters.uploader__ilike || ''}
                  onChange={(e) => setTempFilters({
                    ...tempFilters,
